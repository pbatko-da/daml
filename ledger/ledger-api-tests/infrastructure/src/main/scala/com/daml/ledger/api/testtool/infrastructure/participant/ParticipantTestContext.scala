...
import com.daml.ledger.api.testtool.infrastructure.time.{DelayMechanism, StaticTimeDelayMechanism, TimeDelayMechanism}
import com.daml.ledger.api.testtool.infrastructure.{Endpoint, Identification, LedgerServices, PartyAllocationConfiguration}
import com.daml.ledger.api.tls.TlsConfiguration
import com.daml.ledger.api.v1.active_contracts_service.{GetActiveContractsRequest, GetActiveContractsResponse}
import com.daml.ledger.api.v1.admin.config_management_service.{GetTimeModelRequest, GetTimeModelResponse, SetTimeModelRequest, SetTimeModelResponse, TimeModel}
import com.daml.ledger.api.v1.admin.package_management_service.{ListKnownPackagesRequest, PackageDetails, UploadDarFileRequest}
import com.daml.ledger.api.v1.admin.participant_pruning_service.{PruneRequest, PruneResponse}
import com.daml.ledger.api.v1.admin.party_management_service.{AllocatePartyRequest, GetParticipantIdRequest, GetPartiesRequest, ListKnownPartiesRequest, PartyDetails}
import com.daml.ledger.api.v1.admin.user_management_service.{CreateUserRequest, User}
import com.daml.ledger.api.v1.admin.user_management_service.UserManagementServiceGrpc.UserManagementService
import com.daml.ledger.api.v1.command_completion_service.{Checkpoint, CompletionEndRequest, CompletionEndResponse, CompletionStreamRequest, CompletionStreamResponse}
import com.daml.ledger.api.v1.command_service.{SubmitAndWaitForTransactionIdResponse, SubmitAndWaitForTransactionResponse, SubmitAndWaitForTransactionTreeResponse, SubmitAndWaitRequest}
...
import com.daml.ledger.api.v1.ledger_configuration_service.{GetLedgerConfigurationRequest, GetLedgerConfigurationResponse, LedgerConfiguration}
...
import com.daml.ledger.api.v1.transaction_service.{GetLedgerEndRequest, GetTransactionByEventIdRequest, GetTransactionByIdRequest, GetTransactionsRequest, GetTransactionsResponse}
...
private[testtool] final class ParticipantTestContext private[participant] (
  ...
  val createdUsers = new mutable.ArrayBuffer[User]

  def deleteCreateUsers(): Future[Unit] = {
    ???
  }
  ...
  def createUser(createUserRequest: CreateUserRequest) = {
    for {
      ...
      _ = createdUsers.addOne(response.user)
    } yield response
  }
