...
private[backend] trait StorageBackendTestsParticipantPartyRecord
    extends Matchers
    with Inside
  ...
  // TODO pbatko: Rename tab party_records
  override def resourceAnnotationsTableName: String = "participant_party_annotations"
  ...
  ): ParticipantPartyRecordStorageBackend.DbPartyRecordPayload = {
