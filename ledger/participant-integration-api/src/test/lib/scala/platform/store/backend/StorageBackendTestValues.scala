...
private[backend] object StorageBackendTestValues {
  ...
  def ledgerEnd(o: Long, e: Long): StorageBackend.LedgerEnd = StorageBackend.LedgerEnd(offset(o), e)
  ...
  val someIdentityParams: StorageBackend.IdentityParams =
    StorageBackend.IdentityParams(someLedgerId, someParticipantId)
