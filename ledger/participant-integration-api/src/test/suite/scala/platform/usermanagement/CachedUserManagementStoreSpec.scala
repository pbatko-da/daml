...
// TODO pbatko: Maybe using a custom dummy rather than Mockit.mock would be simpler
//              Or spy on InMemory version
...
//      .thenReturn(Future.successful(Right(emptyUserRights)))
    ...
    for {
      ...
      // TOOD pbatko: What's the correct way to wait for cache entries' expiry?
