...
import com.daml.platform.store.backend.common.{
  ...
  ParticipantPartyRecordStorageBackendTemplate,
...
import com.daml.platform.store.backend.{
  ...
  ParticipantPartyRecordStorageBackend,
  PartyStorageBackend,
  ResetStorageBackend,
...
object H2StorageBackendFactory extends StorageBackendFactory with CommonStorageBackendFactory {
  ...
  override def createParticipantPartyStorageBackend: ParticipantPartyRecordStorageBackend =
    new ParticipantPartyRecordStorageBackendTemplate()
