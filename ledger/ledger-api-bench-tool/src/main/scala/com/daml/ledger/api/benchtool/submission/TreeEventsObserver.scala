...
import com.daml.ledger.api.benchtool.submission.TreeEventsObserver._
...
//        event.event.archived.foreach { archived =>
//          val argsSize = archived.choiceArgument.fold(0)(_.serializedSize)
//          val templateName = archived.templateId
//            .getOrElse(sys.error(s"Expected templateId in $archived"))
//            .entityName
//          val choiceName = archived.choice
//          exerciseEvents.addOne(
//            ObservedExerciseEvent(
//              templateName = templateName,
//              choiceName = choiceName,
//              choiceArgumentsSerializedSize = argsSize,
//              consuming = archived.consuming,
//            )
//          )
//        }
      }
