...
import com.daml.error.generator.{ErrorCodeDocItem, ErrorDefinitionsDocParser, ErrorGroupDocItem}
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    val errorCodes = ErrorDefinitionsDocParser.getErrorCodeItems()
    val groups = ErrorDefinitionsDocParser.getErrorGroupItems()
